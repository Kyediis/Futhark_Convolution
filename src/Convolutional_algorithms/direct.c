...
static void futrts_cli_entry_main(struct futhark_context *ctx)
{
    ...
    int time_runs;
    struct futhark_f32_2d *read_value_6051;
    int64_t read_shape_6052[2];
    float *read_arr_6053 = NULL;
    
    errno = 0;
    if (read_array(&f32_info, (void **) &read_arr_6053, read_shape_6052, 2) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 0, "[][]",
              f32_info.type_name, strerror(errno));
    
    struct futhark_f32_2d *read_value_6054;
    int64_t read_shape_6055[2];
    float *read_arr_6056 = NULL;
    
    errno = 0;
    if (read_array(&f32_info, (void **) &read_arr_6056, read_shape_6055, 2) !=
        0)
        panic(1, "Cannot read input #%d of type %s%s (errno: %s).\n", 1, "[][]",
              f32_info.type_name, strerror(errno));
    
    struct futhark_f32_2d *result_6057;
    ...
    if (perform_warmup) {
        ...
        assert((read_value_6051 = futhark_new_f32_2d(ctx, read_arr_6053,
                                                     read_shape_6052[0],
                                                     read_shape_6052[1])) != 0);
        assert((read_value_6054 = futhark_new_f32_2d(ctx, read_arr_6056,
                                                     read_shape_6055[0],
                                                     read_shape_6055[1])) != 0);
        assert(futhark_context_sync(ctx) == 0);
        t_start = get_wall_time();
        r = futhark_entry_main(ctx, &result_6057, read_value_6051,
                               read_value_6054);
        if (r != 0)
        ...
        assert(futhark_free_f32_2d(ctx, read_value_6051) == 0);
        assert(futhark_free_f32_2d(ctx, read_value_6054) == 0);
        assert(futhark_free_f32_2d(ctx, result_6057) == 0);
    }
    time_runs = 1;
    /* Proper run. */
    ...
    free(read_arr_6056);
    {
        float *arr = calloc(sizeof(float), futhark_shape_f32_2d(ctx,
                                                                result_6057)[0] *
                            futhark_shape_f32_2d(ctx, result_6057)[1]);
        
        assert(arr != NULL);
        assert(futhark_values_f32_2d(ctx, result_6057, arr) == 0);
        write_array(stdout, binary_output, &f32_info, arr,
                    futhark_shape_f32_2d(ctx, result_6057), 2);
        free(arr);
    }
    printf("\n");
    assert(futhark_free_f32_2d(ctx, result_6057) == 0);
...
const char *opencl_program[] =
           {"#ifdef cl_clang_storage_class_specifiers\n#pragma OPENCL EXTENSION cl_clang_storage_class_specifiers : enable\n#endif\n__kernel void dummy_kernel(__global unsigned char *dummy, int n)\n{\n    const int thread_gid = get_global_id(0);\n    \n    if (thread_gid >= n)\n        return;\n}\ntypedef char int8_t;\ntypedef short int16_t;\ntypedef int int32_t;\ntypedef long int64_t;\ntypedef uchar uint8_t;\ntypedef ushort uint16_t;\ntypedef uint uint32_t;\ntypedef ulong uint64_t;\n#define ALIGNED_LOCAL_MEMORY(m,size) __local unsigned char m[size] __attribute__ ((align))\nstatic inline int8_t add8(int8_t x, int8_t y)\n{\n    return x + y;\n}\nstatic inline int16_t add16(int16_t x, int16_t y)\n{\n    return x + y;\n}\nstatic inline int32_t add32(int32_t x, int32_t y)\n{\n    return x + y;\n}\nstatic inline int64_t add64(int64_t x, int64_t y)\n{\n    return x + y;\n}\nstatic inline int8_t sub8(int8_t x, int8_t y)\n{\n    return x - y;\n}\nstatic inline int16_t sub16(int16_t x, int16_t y)\n{\n    return x - y;\n}\nstatic inline int32_t sub32(int32_t x, int32_t y)\n{\n    return x - y;\n}\nstatic inline int64_t sub64(int64_t x, int64_t y)\n{\n    return x - y;\n}\nstatic inline int8_t mul8(int8_t x, int8_t y)\n{\n    return x * y;\n}\nstatic inline int16_t mul16(int16_t x, int16_t y)\n{\n    return x * y;\n}\nstatic inline int32_t mul32(int32_t x, int32_t y)\n{\n    return x * y;\n}\nstatic inline int64_t mul64(int64_t x, int64_t y)\n{\n    return x * y;\n}\nstatic inline uint8_t udiv8(uint8_t x, uint8_t y)\n{\n    return x / y;\n}\nstatic inline uint16_t udiv16(uint16_t x, uint16_t y)\n{\n    return x / y;\n}\nstatic inline uint32_t udiv32(uint32_t x, uint32_t y)\n{\n    return x / y;\n}\nstatic inline uint64_t udiv64(uint64_t x, uint64_t y)\n{\n    return x / y;\n}\nstatic inline uint8_t umod8(uint8_t x, uint8_t y)\n{\n    return x % y;\n}\nstatic inline uint16_t umod16(uint16_t x, uint16_t y)\n{\n    return x % y;\n}\nstatic inline uint32_t umod32(uint32_t x, uint32_t y)\n{\n    return x % y;\n}\nstatic inline uint64_t umod64(uint64_t x, uint64_t y)\n{\n    return x % y;\n}",
            ...
            "nan(x);\n}\nstatic inline char futrts_isinf32(float x)\n{\n    return isinf(x);\n}\nstatic inline int32_t futrts_to_bits32(float x)\n{\n    union {\n        float f;\n        int32_t t;\n    } p;\n    \n    p.f = x;\n    return p.t;\n}\nstatic inline float futrts_from_bits32(int32_t x)\n{\n    union {\n        int32_t f;\n        float t;\n    } p;\n    \n    p.f = x;\n    return p.t;\n}\n__kernel void map_5788(int32_t sizze_5478, int32_t num_elems_5491,\n                       int32_t num_elems_5497, float y_5499, float y_5500,\n                       int32_t y_5501, float y_5502, float y_5503, float y_5504,\n                       float y_5505, int32_t y_5506, float y_5507, float y_5508,\n                       float y_5509, __global unsigned char *data_mem_6019,\n                       __global unsigned char *mem_6025)\n{\n    const int block_dim0 = 0;\n    const int block_dim1 = 1;\n    const int block_dim2 = 2;\n    int32_t wave_sizze_6031;\n    int32_t group_sizze_6032;\n    int32_t gtid_5779;\n    int32_t gtid_5780;\n    int32_t global_tid_5788;\n    int32_t local_tid_5789;\n    int32_t group_id_5790;\n    \n    global_tid_5788 = get_global_id(0);\n    local_tid_5789 = get_local_id(0);\n    group_sizze_6032 = get_local_size(0);\n    wave_sizze_6031 = LOCKSTEP_WIDTH;\n    group_id_5790 = get_group_id(0);\n    gtid_5779 = squot32(global_tid_5788, num_elems_5497);\n    gtid_5780 = global_tid_5788 - squot32(global_tid_5788, num_elems_5497) *\n        num_elems_5497;\n    \n    int32_t index_primexp_6007;\n    bool unop_x_6016;\n    bool index_primexp_6017;\n    bool unop_x_6013;\n    bool index_primexp_6014;\n    int32_t index_primexp_6011;\n    int32_t index_primexp_6005;\n    float res_5960;\n    float x_5961;\n    float res_5962;\n    float y_5963;\n    float x_5964;\n    bool res_5965;\n    bool res_5966;\n    float x_5967;\n    float y_5971;\n    float x_5972;\n    float res_5974;\n    float y_5975;\n    float x_5976;\n    float x_5977;\n    float y_5978;\n    float x_5979;\n    float x_5980;\n    float y_5983;\n    float x_5984;\n    ",
            "float x_5985;\n    float y_5988;\n    float x_5989;\n    float x_5990;\n    float y_5992;\n    float x_5993;\n    bool x_5994;\n    float x_5995;\n    float y_5999;\n    float res_6000;\n    \n    if (slt32(gtid_5779, num_elems_5491) && slt32(gtid_5780, num_elems_5497)) {\n        index_primexp_6007 = 1 + gtid_5779;\n        unop_x_6016 = index_primexp_6007 == y_5501;\n        index_primexp_6017 = !unop_x_6016;\n        unop_x_6013 = index_primexp_6007 == y_5506;\n        index_primexp_6014 = !unop_x_6013;\n        index_primexp_6011 = 1 + index_primexp_6007;\n        index_primexp_6005 = 1 + gtid_5780;\n        res_5960 = *(__global float *) &data_mem_6019[(gtid_5779 * sizze_5478 +\n                                                       gtid_5780) * 4];\n        x_5961 = y_5499 * res_5960;\n        res_5962 = *(__global float *) &data_mem_6019[(gtid_5779 * sizze_5478 +\n                                                       index_primexp_6005) * 4];\n        y_5963 = y_5500 * res_5962;\n        x_5964 = x_5961 + y_5963;\n        res_5965 = index_primexp_6005 == y_5501;\n        res_5966 = !res_5965;\n        if (res_5966) {\n            int32_t i_5969;\n            float res_5970;\n            \n            i_5969 = 1 + index_primexp_6005;\n            res_5970 = *(__global float *) &data_mem_6019[(gtid_5779 *\n                                                           sizze_5478 +\n                                                           i_5969) * 4];\n            x_5967 = res_5970;\n        } else {\n            x_5967 = 0.0F;\n        }\n        y_5971 = y_5502 * x_5967;\n        x_5972 = x_5964 + y_5971;\n        res_5974 = *(__global float *) &data_mem_6019[(index_primexp_6007 *\n                                                       sizze_5478 + gtid_5780) *\n                                                      4];\n        y_5975 = y_5503 * res_5974;\n        x_5976 = x_5972 + y_5975;\n        x_5977 = *(__global float *) &data_mem_6019[(index_primexp_6007 *\n                                           ",
            "          sizze_5478 +\n                                                     index_primexp_6005) * 4];\n        y_5978 = y_5504 * x_5977;\n        x_5979 = x_5976 + y_5978;\n        if (index_primexp_6017) {\n            int32_t i_5981;\n            float res_5982;\n            \n            i_5981 = 1 + index_primexp_6005;\n            res_5982 = *(__global float *) &data_mem_6019[(index_primexp_6007 *\n                                                           sizze_5478 +\n                                                           i_5981) * 4];\n            x_5980 = res_5982;\n        } else {\n            x_5980 = 0.0F;\n        }\n        y_5983 = y_5505 * x_5980;\n        x_5984 = x_5979 + y_5983;\n        if (index_primexp_6014) {\n            float res_5987 = *(__global\n                               float *) &data_mem_6019[(index_primexp_6011 *\n                                                        sizze_5478 +\n                                                        gtid_5780) * 4];\n            \n            x_5985 = res_5987;\n        } else {\n            x_5985 = 0.0F;\n        }\n        y_5988 = y_5507 * x_5985;\n        x_5989 = x_5984 + y_5988;\n        if (index_primexp_6014) {\n            float res_5991 = *(__global\n                               float *) &data_mem_6019[(index_primexp_6011 *\n                                                        sizze_5478 +\n                                                        index_primexp_6005) *\n                                                       4];\n            \n            x_5990 = res_5991;\n        } else {\n            x_5990 = 0.0F;\n        }\n        y_5992 = y_5508 * x_5990;\n        x_5993 = x_5989 + y_5992;\n        x_5994 = res_5966 && index_primexp_6014;\n        if (x_5994) {\n            int32_t i_5997;\n            float res_5998;\n            \n            i_5997 = 1 + index_primexp_6005;\n            res_5998 = *(__global float *) &data_mem_6019[(index_primexp_6011 *\n                                                         ",
            "  sizze_5478 +\n                                                           i_5997) * 4];\n            x_5995 = res_5998;\n        } else {\n            x_5995 = 0.0F;\n        }\n        y_5999 = y_5509 * x_5995;\n        res_6000 = x_5993 + y_5999;\n    }\n    if (slt32(gtid_5779, num_elems_5491) && slt32(gtid_5780, num_elems_5497)) {\n        *(__global float *) &mem_6025[(gtid_5779 * num_elems_5497 + gtid_5780) *\n                                      4] = res_6000;\n    }\n}\n",
            NULL};
...
static const char *size_names[] = {"main.group_size_5782"};
static const char *size_vars[] = {"mainzigroup_sizze_5782"};
                             ...
                             struct futhark_context *ctx, cl_program prog)
{
    ...
    {
        ctx->map_5788 = clCreateKernel(prog, "map_5788", &error);
        OPENCL_SUCCEED_FATAL(error);
        if (ctx->debugging)
            fprintf(stderr, "Created kernel %s.\n", "map_5788");
    }
    ctx->sizes.mainzigroup_sizze_5782 = cfg->sizes[0];
    return 0;
}
struct futhark_context *futhark_context_new(struct futhark_context_config *cfg)
{
...
void futhark_debugging_report(struct futhark_context *ctx)
{
    ...
    if (ctx->debugging) {
        fprintf(stderr,
                "Kernel map_5788 executed %6d times, with average runtime: %6ldus\tand total runtime: %6ldus\n",
                ctx->map_5788_runs, (long) ctx->map_5788_total_runtime /
                (ctx->map_5788_runs != 0 ? ctx->map_5788_runs : 1),
                (long) ctx->map_5788_total_runtime);
        ctx->total_runtime += ctx->map_5788_total_runtime;
        ctx->total_runs += ctx->map_5788_runs;
        if (ctx->debugging)
...
static int futrts_main(struct futhark_context *ctx,
                       int64_t *out_out_memsizze_6033,
                       struct memblock_device *out_mem_p_6034,
                       int32_t *out_out_arrsizze_6035,
                       int32_t *out_out_arrsizze_6036,
                       int64_t data_mem_sizze_6018,
                       struct memblock_device data_mem_6019,
                       int64_t kernel_mem_sizze_6020,
                       struct memblock_device kernel_mem_6021,
                       int32_t sizze_5477, int32_t sizze_5478,
                       int32_t sizze_5479, int32_t sizze_5480);
static inline int8_t add8(int8_t x, int8_t y)
{
    return x + y;
}
...
static int futrts_main(struct futhark_context *ctx,
                       ...
                       int32_t sizze_5479, int32_t sizze_5480)
{
    int64_t out_memsizze_6028;
    struct memblock_device out_mem_6027;
    
    out_mem_6027.references = NULL;
    
    int32_t out_arrsizze_6029;
    int32_t out_arrsizze_6030;
    bool dim_match_5483 = 3 == sizze_5479;
    bool dim_match_5484 = 3 == sizze_5480;
    bool match_5485 = dim_match_5483 && dim_match_5484;
    bool empty_or_match_cert_5486;
    
    if (!match_5485) {
        ctx->error = msgprintf("Error at %s:\n%s\n", "direct.fut:39:3-45:10",
                               "function arguments of wrong shape");
        if (memblock_unref_device(ctx, &out_mem_6027, "out_mem_6027") != 0)
            return 1;
        return 1;
    }
    
    int32_t range_end_5487 = sizze_5477 - 2;
    bool bounds_invalid_upwards_5488 = slt32(range_end_5487, 1);
    int32_t distance_upwards_exclusive_5489 = range_end_5487 - 1;
    int32_t distance_5490 = 1 + distance_upwards_exclusive_5489;
    int32_t num_elems_5491;
    
    if (bounds_invalid_upwards_5488) {
        num_elems_5491 = 0;
    } else {
        num_elems_5491 = distance_5490;
    }
    
    int32_t range_end_5493 = sizze_5478 - 2;
    bool bounds_invalid_upwards_5494 = slt32(range_end_5493, 1);
    int32_t distance_upwards_exclusive_5495 = range_end_5493 - 1;
    int32_t distance_5496 = 1 + distance_upwards_exclusive_5495;
    int32_t num_elems_5497;
    
    if (bounds_invalid_upwards_5494) {
        num_elems_5497 = 0;
    } else {
        num_elems_5497 = distance_5496;
    }
    
    float read_res_6037;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 0 * sizze_5480 * 4,
                                                 sizeof(float), &read_res_6037,
                                                 0, NULL, NULL));
    
    float y_5499 = read_res_6037;
    float read_res_6038;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 (0 * sizze_5480 + 1) * 4,
                                                 sizeof(float), &read_res_6038,
                                                 0, NULL, NULL));
    
    float y_5500 = read_res_6038;
    int32_t y_5501 = sizze_5478 - 1;
    float read_res_6039;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 (0 * sizze_5480 + 2) * 4,
                                                 sizeof(float), &read_res_6039,
                                                 0, NULL, NULL));
    
    float y_5502 = read_res_6039;
    float read_res_6040;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 sizze_5480 * 4, sizeof(float),
                                                 &read_res_6040, 0, NULL,
                                                 NULL));
    
    float y_5503 = read_res_6040;
    float read_res_6041;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 (sizze_5480 + 1) * 4,
                                                 sizeof(float), &read_res_6041,
                                                 0, NULL, NULL));
    
    float y_5504 = read_res_6041;
    float read_res_6042;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 (sizze_5480 + 2) * 4,
                                                 sizeof(float), &read_res_6042,
                                                 0, NULL, NULL));
    
    float y_5505 = read_res_6042;
    int32_t y_5506 = sizze_5477 - 1;
    float read_res_6043;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 2 * sizze_5480 * 4,
                                                 sizeof(float), &read_res_6043,
                                                 0, NULL, NULL));
    
    float y_5507 = read_res_6043;
    float read_res_6044;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 (2 * sizze_5480 + 1) * 4,
                                                 sizeof(float), &read_res_6044,
                                                 0, NULL, NULL));
    
    float y_5508 = read_res_6044;
    float read_res_6045;
    
    OPENCL_SUCCEED_OR_RETURN(clEnqueueReadBuffer(ctx->opencl.queue,
                                                 kernel_mem_6021.mem, CL_TRUE,
                                                 (2 * sizze_5480 + 2) * 4,
                                                 sizeof(float), &read_res_6045,
                                                 0, NULL, NULL));
    
    float y_5509 = read_res_6045;
    int32_t nesting_sizze_5944 = num_elems_5491 * num_elems_5497;
    int32_t group_sizze_5945;
    
    group_sizze_5945 = ctx->sizes.mainzigroup_sizze_5782;
    
    int32_t y_5946 = group_sizze_5945 - 1;
    int32_t x_5947 = nesting_sizze_5944 + y_5946;
    int32_t num_groups_5948 = squot32(x_5947, group_sizze_5945);
    int32_t num_threads_5949 = group_sizze_5945 * num_groups_5948;
    int64_t binop_x_6024 = sext_i32_i64(nesting_sizze_5944);
    int64_t bytes_6022 = 4 * binop_x_6024;
    struct memblock_device mem_6025;
    
    mem_6025.references = NULL;
    if (memblock_alloc_device(ctx, &mem_6025, bytes_6022, "mem_6025"))
        return 1;
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 0,
                                            sizeof(sizze_5478), &sizze_5478));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 1,
                                            sizeof(num_elems_5491),
                                            &num_elems_5491));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 2,
                                            sizeof(num_elems_5497),
                                            &num_elems_5497));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 3, sizeof(y_5499),
                                            &y_5499));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 4, sizeof(y_5500),
                                            &y_5500));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 5, sizeof(y_5501),
                                            &y_5501));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 6, sizeof(y_5502),
                                            &y_5502));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 7, sizeof(y_5503),
                                            &y_5503));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 8, sizeof(y_5504),
                                            &y_5504));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 9, sizeof(y_5505),
                                            &y_5505));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 10, sizeof(y_5506),
                                            &y_5506));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 11, sizeof(y_5507),
                                            &y_5507));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 12, sizeof(y_5508),
                                            &y_5508));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 13, sizeof(y_5509),
                                            &y_5509));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 14,
                                            sizeof(data_mem_6019.mem),
                                            &data_mem_6019.mem));
    OPENCL_SUCCEED_OR_RETURN(clSetKernelArg(ctx->map_5788, 15,
                                            sizeof(mem_6025.mem),
                                            &mem_6025.mem));
    if (1 * (num_groups_5948 * group_sizze_5945) != 0) {
        const size_t global_work_sizze_6046[1] = {num_groups_5948 *
                     group_sizze_5945};
        const size_t local_work_sizze_6050[1] = {group_sizze_5945};
        int64_t time_start_6047 = 0, time_end_6048 = 0;
        
        if (ctx->debugging) {
            fprintf(stderr, "Launching %s with global work size [", "map_5788");
            fprintf(stderr, "%zu", global_work_sizze_6046[0]);
            fprintf(stderr, "] and local work size [");
            fprintf(stderr, "%zu", local_work_sizze_6050[0]);
            fprintf(stderr, "].\n");
            time_start_6047 = get_wall_time();
        }
        OPENCL_SUCCEED_OR_RETURN(clEnqueueNDRangeKernel(ctx->opencl.queue,
                                                        ctx->map_5788, 1, NULL,
                                                        global_work_sizze_6046,
                                                        local_work_sizze_6050,
                                                        0, NULL, NULL));
        if (ctx->debugging) {
            OPENCL_SUCCEED_FATAL(clFinish(ctx->opencl.queue));
            time_end_6048 = get_wall_time();
            
            long time_diff_6049 = time_end_6048 - time_start_6047;
            
            ctx->map_5788_total_runtime += time_diff_6049;
            ctx->map_5788_runs++;
            fprintf(stderr, "kernel %s runtime: %ldus\n", "map_5788",
                    time_diff_6049);
        }
    }
    out_arrsizze_6029 = num_elems_5491;
    out_arrsizze_6030 = num_elems_5497;
    out_memsizze_6028 = bytes_6022;
    if (memblock_set_device(ctx, &out_mem_6027, &mem_6025, "mem_6025") != 0)
        return 1;
    *out_out_memsizze_6033 = out_memsizze_6028;
    (*out_mem_p_6034).references = NULL;
    if (memblock_set_device(ctx, &*out_mem_p_6034, &out_mem_6027,
                            "out_mem_6027") != 0)
        return 1;
    *out_out_arrsizze_6035 = out_arrsizze_6029;
    *out_out_arrsizze_6036 = out_arrsizze_6030;
    if (memblock_unref_device(ctx, &mem_6025, "mem_6025") != 0)
        return 1;
    if (memblock_unref_device(ctx, &out_mem_6027, "out_mem_6027") != 0)
        return 1;
    return 0;
                       ...
                       struct futhark_f32_2d *in1)
{
    ...
    data_mem_6019.references = NULL;
    
    int64_t kernel_mem_sizze_6020;
    struct memblock_device kernel_mem_6021;
    
    kernel_mem_6021.references = NULL;
    ...
    lock_lock(&ctx->lock);
    data_mem_6019 = in0->mem;
    data_mem_sizze_6018 = in0->mem.size;
    sizze_5477 = in0->shape[0];
    sizze_5478 = in0->shape[1];
    kernel_mem_6021 = in1->mem;
    kernel_mem_sizze_6020 = in1->mem.size;
    sizze_5479 = in1->shape[0];
    sizze_5480 = in1->shape[1];
    
    int ret = futrts_main(ctx, &out_memsizze_6028, &out_mem_6027,
                          &out_arrsizze_6029, &out_arrsizze_6030,
                          data_mem_sizze_6018, data_mem_6019,
                          kernel_mem_sizze_6020, kernel_mem_6021, sizze_5477,
                          sizze_5478, sizze_5479, sizze_5480);
    
    if (ret == 0) {
        assert((*out0 = malloc(sizeof(struct futhark_f32_2d))) != NULL);
        (*out0)->mem = out_mem_6027;
        (*out0)->shape[0] = out_arrsizze_6029;
        (*out0)->shape[1] = out_arrsizze_6030;
    }
    lock_unlock(&ctx->lock);
    return ret;
}
